        ...
        <div className='flex flex-col items-center gap-4 bg-white'>
          <div className='details-page-header-section'>
            ...
            <Fade direction='down' duration={1000}>
              <p>Dental Emergencies for Newark and East Orange, NJ | Maple Dental</p>
            </Fade>
          </div>
            ...
            <Accordion type='multiple' defaultValue={['q1', 'q2', 'q3']} className='w-full space-y-5'>
              ...
              <AccordionItem value='q2'>
                ...
                <AccordionContent className='faq-ans'>
                  ...
                  <p className='mt-3'>If you experience oral trauma due to a sports injury, car accident, or fall, or if you have pain and bleeding after a tooth extraction, call Maple Dental right away.</p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value='q3'>
                ...
                <AccordionContent className='faq-ans'>
                  ...
                  <p className='mt-3'>Despite precautions, emergencies can still occur. If you or a loved one need urgent dental care, make an appointment at Maple Dental by calling the office, walking in, or booking online today.</p>
