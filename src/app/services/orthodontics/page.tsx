        ...
        <div className='flex flex-col items-center gap-4 bg-white'>
          <div className='details-page-header-section'>
            ...
            <Fade direction='down' duration={1000}>
              <p>Orthodontics for Newark and East Orange, NJ | Maple Dental</p>
            </Fade>
          </div>
          ...
          <div className='details-page-desc-section'>
            ...
            <div className='desc-text-section'>
              <Fade cascade direction='up' delay={1000} duration={600}>
                ...
                <p>
                  If you’re experiencing discomfort from dental issues like crowding, crossbite, overbite, or underbite, you’re not alone. If you’re looking for an experienced dentist near you, Maple Dental offers proven orthodontic treatments to correct bites and straighten smiles. With locations in Newark and East Orange, New Jersey, the team is ready to help. Call the office or book an appointment online today.
                </p>
              </Fade>
            </div>
          </div>
            ...
            <Accordion type='multiple' defaultValue={['q1', 'q2', 'q3', 'q4']} className='w-full space-y-5'>
              <AccordionItem value='q1'>
                ...
                <AccordionContent className='faq-ans'>
                  <p>Orthodontics is a dentistry specialty that involves adjusting the alignment of your teeth and jaw. The team at Maple Dental helps patients of all ages gain their confidence back by diagnosing, preventing, and correcting misaligned teeth.</p>
                  ...
                  <p className='mt-3'>Maple Dental treats both severe spacing issues and simple cosmetic adjustments with orthodontics.</p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value='q2'>
                ...
                <AccordionContent className='faq-ans'>
                  <p>At Maple Dental, the dental team provides multiple options for braces, including:</p>
                  <ul className='list-disc list-inside mt-2 space-y-2'>
                  ...
                  <p className='mt-3'>While certain bite corrections require a specific type of braces, Maple Dental offers various choices to suit your preference and condition.</p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value='q4'>
                ...
                <AccordionContent className='faq-ans'>
                  <p>Call Maple Dental or schedule an online appointment today to begin your journey toward a more confident smile with professional orthodontic care.</p>
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
