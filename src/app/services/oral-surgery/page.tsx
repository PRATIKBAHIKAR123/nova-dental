...
export default function OralSurgeryPage() {
    return (
        <div className='flex flex-col items-center gap-4 bg-white'>
            <div className='details-page-header-section'>
                ...
                <p>
                    Oral Surgery for Newark and East Orange, NJ | Nova Dental | Cosmetic & Family Dentist
                </p>
                </Fade>
      ...
      <div className='desc-text-section'>
        <Fade cascade direction="up" delay={1000} duration={600}>
          ...
          <p>
            While most dental procedures are noninvasive, some situations require oral surgery. If you&aosp;re looking for a trusted dentist near you, Nova Dental provides a range of oral surgery services, including extractions, root canals, and dental implant placements. To schedule an appointment at their Newark or East Orange, New Jersey locations, call the office or book online today.
          </p>
        </Fade>
      </div>
    </div>
    ...
    <div className='faq-section'>
        ...
        <AccordionItem value="q2">
          ...
          <AccordionContent className='faq-ans'>
            <p>Nova Dental offers various types of oral surgery, including:</p>
        ...
        <AccordionItem value="q3">
          ...
          <AccordionContent className='faq-ans'>
            <p>To determine if you’re a candidate for oral surgery, your Nova Dental provider does an oral exam, reviews your dental health history, and asks about your symptoms, including when they started and if any activities like biting or chewing make them worse. Afterward, they order a series of oral X-rays to assess parts of your mouth invisible to the naked eye.</p>
