    ...
    return (
        <div className='flex flex-col items-center gap-4 bg-white'>
            <div className='details-page-header-section'>
                ...
                <p>
                    Fillings for Newark and East Orange, NJ | Nova Dental | Cosmetic & Family Dentist
                </p>
                </Fade>
      ...
      <div className='desc-text-section'>
        <Fade cascade direction="up" delay={1000} duration={600}>
          ...
          <p>
            It’s estimated that 92% of American adults have fillings. These restorative treatments help prevent further tooth decay and preserve your smile for years to come. If you’re looking for a dentist near you, Nova Dental offers tooth-colored fillings to keep your teeth healthy and strong. To schedule an appointment at their Newark or East Orange, New Jersey locations, call the office or book online today.
          </p>
        </Fade>
      </div>
    </div>
    ...
    <div className='faq-section'>
        ...
        <AccordionItem value="q1">
          ...
          <AccordionContent className='faq-ans'>
            <p>Fillings are a restorative dentistry procedure that repairs tooth enamel damaged by decay. There are several types of fillings, but Nova Dental administers tooth-colored ones. Tooth-colored fillings match the shade and light-reflecting properties of your natural enamel, ensuring they blend in with your surrounding teeth.</p>
            <p className="mt-3">
        ...
        <AccordionItem value="q2">
          ...
          <AccordionContent className='faq-ans'>
            <p>At Nova Dental, getting a filling often takes less than an hour. Before recommending a filling, your provider does an oral exam and takes X-rays to assess your affected tooth. Next, they administer a local anesthetic and carefully remove the decaying portion of tooth enamel. </p>
            <p className="mt-3">
        ...
        <AccordionItem value="q3">
          ...
          <AccordionContent className='faq-ans'>
            <p>Getting fillings is a quick, pain-free procedure. Once the anesthesia wears off, it’s normal to experience some increased tooth sensitivity, but that should subside within a week. To minimize any discomfort, Nova Dental recommends:</p>
